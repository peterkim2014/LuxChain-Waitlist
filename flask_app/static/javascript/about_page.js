$(document).ready(function () {
    ...
    function handleResize() {
        ...
        //         'font-size': '0.9em'
        //     })
        //     $('.intro-title-body > p').css({
        //         'font-size': '0.75em',
        //         'width': '100%'
        //     })
        //     $('.intro-title-body').css({
        //         'height': '30%',
        //         'margin-top': '-3.5%',
        //         'width': '100%'
        //     })
        //     $('.intro-title-footer').css({
        //         'margin-top': '-0.5%',
        //         'font-size': '0.8em'
        //     })
        //     $('#about-company').css({
        ...
        //         'gap': '1.5vh'
        //     })
        //     $('.company-vision > h2').css({
        //         'font-size': '1.25em'
        //     })
        //     $('.company-vision > p').css({
        //         'font-size': '0.72em',
        //         'width': '55%'
        //     })
        //     $('.company-mission').css({
        ...
        //         'gap': '1.5vh'
        //     })
        //     $('.company-mission > h2').css({
        //         'font-size': '1.25em'
        //     })
        //     $('.company-mission > p').css({
        //         'font-size': '0.72em',
        //         'width': '55%'
        //     })
        //     $('.company-purpose').css({
        ...
        //         'gap': '1.5vh'
        //     })
        //     $('.company-purpose > h2').css({
        //         'font-size': '1.25em'
        //     })
        //     $('.company-purpose > p').css({
        //         'font-size': '0.72em',
        //         'width': '75%'
        //     })
        //     $('.company-problems').css({
        //         'height': '25vh',
        //         'margin-top': '24%'
        //     })
        //     $('.problem-text').css({
